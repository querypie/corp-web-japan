...
<br />`
  ...
  "16": {
    ...
    "content": `<p><br /></p>
<br />
<p><a class="article-content-btn article-content-btn--wide" href="#gating-wall" onclick="document.getElementById('gating-wall').scrollIntoView({behavior:'smooth',block:'start'});return false;">ホワイトペーパーを入手する 🚀</a></p>
<br />
<p><br /></p>
<br />
<h1 id="はじめに">はじめに</h1>
