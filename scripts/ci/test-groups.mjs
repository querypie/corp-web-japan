...
const matchers = {
  publications: [
    ...
    /^tests\/whitepaper-(canonical-slug-routing|download-route|frontmatter-visibility-and-redirect|gating-source|imported-ja-corpus)\.test\.mjs$/,
    ...
    /^tests\/src\/components\/sections\/(featured-event-hero|resource-list-section)\.test\.mjs$/,
  ...
  forms: [
    /^tests\/contact-us-page-authoring\.test\.mjs$/,
  ...
  staticPages: [
    ...
    /^tests\/aip-usage-based-llm-preview-page\.test\.mjs$/,
    /^tests\/certifications-image-rendering\.test\.mjs$/,
    /^tests\/certifications-preview-route-local-structure\.test\.mjs$/,
    /^tests\/font-and-mobile-layout\.test\.mjs$/,
    /^tests\/internal-page\.test\.mjs$/,
    /^tests\/legal-cookie-preference-preview\.test\.mjs$/,
    /^tests\/legal-eula-preview\.test\.mjs$/,
    ...
    /^tests\/t-services-aip-integrations-page\.test\.mjs$/,
    /^tests\/t-solutions-aip-fde-services-page\.test\.mjs$/,
    /^tests\/t-whitepapers-page\.test\.mjs$/,
