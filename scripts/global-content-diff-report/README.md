...
- Items link to their canonical `www.querypie.com` detail pages. An unmapped News outlink without a verified owned detail URL fails closed instead of linking to an external article or generic index.
