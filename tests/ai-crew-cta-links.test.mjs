...
test("AI Crew CTA links match the intended targets", () => {
  ...
  assert.match(
    aiCrewDataSource,
    /const aiCrewWhitepaperUrl =\s*"https:\/\/www\.querypie\.com\/ja\/features\/documentation\/white-paper\/24\/ai-tranformation-japan"|export const aiCrewWhitepaperUrl =\s*"https:\/\/www\.querypie\.com\/ja\/features\/documentation\/white-paper\/24\/ai-tranformation-japan"/,
  );
