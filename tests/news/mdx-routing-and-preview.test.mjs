...
test("news public page and canonical routes are driven by news MDX publication records", () => {
  ...
  const listPage = readSource("src/components/sections/news/news-list-page.tsx");
  const sectionComponents = readSource("src/components/sections/news/news-page-section.tsx");
  ...
  assert.equal(existsSync(new URL("../../src/components/sections/news/news-page-section.tsx", import.meta.url)), true);
  ...
  assert.doesNotMatch(loader, /buildRelatedPublicationItems\(/);
