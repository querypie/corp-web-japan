...
test("/internal/demo-sections exists as a noindex UI demo route for preserved orphan section components", () => {
  ...
  assert.match(source, /\.\/role-slides/);
  assert.match(source, /\.\/use-case-showcase/);
  assert.match(source, /\.\/ai-crew-avatar/);
  assert.match(source, /\.\/ai-dashi-faq/);
  assert.doesNotMatch(source, /@\/components\/sections\/internal-demo\/role-slides/);
  assert.doesNotMatch(source, /@\/components\/sections\/internal-demo\/use-case-showcase/);
  assert.doesNotMatch(source, /@\/components\/sections\/ai-crew\/avatar/);
  assert.doesNotMatch(source, /@\/components\/sections\/ai-dashi\/faq/);
  assert.equal(sourceExists("src/app/internal/demo-sections/role-slides.tsx"), true);
  assert.equal(sourceExists("src/app/internal/demo-sections/use-case-showcase.tsx"), true);
  assert.equal(sourceExists("src/app/internal/demo-sections/ai-crew-avatar.tsx"), true);
  assert.equal(sourceExists("src/app/internal/demo-sections/ai-dashi-faq.tsx"), true);
  ...
  assert.equal(sourceExists("src/components/sections/internal-demo/role-slides.tsx"), false);
  assert.equal(sourceExists("src/components/sections/internal-demo/use-case-showcase.tsx"), false);
  ...
  assert.match(source, /items={aiDashiFaqItems}/);
  ...
  assert.match(source, /route-local code/);
  ...
  assert.match(source, /route-local visual primitive/);
