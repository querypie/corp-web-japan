...
test("privacy policy route keeps latest alias page and version detail route with public metadata", () => {
...
test("privacy policy public scans shared content filenames and uses the shared legal document contract", () => {
  const versionPageSource = readSource(versionPagePath);
  ...
  assert.equal(sourceExists("src/app/privacy-policy/privacy-policy-document.tsx"), false);
  assert.equal(sourceExists("src/app/privacy-policy/privacy-policy-version-selector.tsx"), false);
  assert.equal(sourceExists("src/app/privacy-policy/privacy-policy-sources.ts"), false);
  assert.equal(sourceExists("src/app/privacy-policy/privacy-policy-versions.ts"), false);
  assert.equal(sourceExists("src/app/privacy-policy/document-renderer.tsx"), false);
  assert.equal(sourceExists("src/app/privacy-policy/version-selector.tsx"), false);
...
test("privacy policy public migrates every upstream English version into src/content/privacy-policy dated MDX files", () => {
  ...
  assert.equal(sourceExists("src/app/privacy-policy/privacy-policy-content.mdx"), false);
