...
test("whitepaper canonical routing keeps the local MDX-backed detail flow and preserves hidden redirect records", () => {
  ...
  assert.equal(sourceExists("src/content/whitepapers/25-ai-transformation-japan.mdx"), true);
  assert.equal(sourceExists("src/lib/publications/whitepapers/records.ts"), true);
