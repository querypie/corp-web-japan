...
- Stage URL: `https://stage.querypie.ai/platforms/acp/system-access-controller`
- Live URL: `https://www.querypie.com/ja/solutions/acp/system-access-controller`
- 로컬 route source: `src/app/platforms/acp/system-access-controller/page.tsx`
...
다음에 확인할 source area:
- route-local section composition: `src/app/platforms/acp/system-access-controller/page.tsx`
...
- page별 문구 소유권을 route-local로 유지해야 한다면 `src/app/platforms/acp/system-access-controller/page.tsx`에 FAQ content를 직접 두는 방향을 검토합니다.
