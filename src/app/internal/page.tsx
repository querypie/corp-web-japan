...
const internalPageCards = [
  {
    ...
    title: "Whitepaper Gating Form",
    href: "/internal/whitepaper-gating-form",
    description:
...
export const metadata: Metadata = {
  title: "Internal Pages | QueryPie AI",
  alternates: {
    canonical: "/internal",
  },
  robots: {
      ...
      <section className="px-6 pb-8 pt-20 sm:px-10 lg:px-16 lg:pb-10 lg:pt-24">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-6 max-w-3xl text-base leading-7 text-slate-600 sm:text-lg">
            이 페이지는 공개 전환 대상이 아닌 internal 전용 허브입니다. 현재 사용 가능한 internal 페이지 {internalPageCards.length}
