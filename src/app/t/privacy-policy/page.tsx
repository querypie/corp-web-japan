...
import { renderPrivacyPolicyPreviewMdx } from "@/lib/legal-preview/privacy-policy";

export const metadata: Metadata = {
  title: "プライバシーポリシー | QueryPie AI",
  description: "QueryPie Privacy Policy の current version preview ページです。",
  alternates: {
      ...
      <section className="mx-auto max-w-[1920px] bg-white px-[30px] pb-[120px] pt-[112px] lg:px-[30px] lg:pb-[160px] lg:pt-[144px]">
        <div className="mx-auto max-w-[920px]">
          <div className="border-b border-[#d1d5db] pb-6">
            <h1 className="text-[34px] font-normal leading-[1.2] text-slate-950 lg:text-[40px]">プライバシーポリシー</h1>
            <p className="mt-4 text-base leading-7 text-slate-500">
              corp-web-contents の current privacy-policy source を元にした preview ページです。
            </p>
          </div>
