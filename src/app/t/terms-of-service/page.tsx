...
export const metadata: Metadata = {
  title: "利用規約 | QueryPie AI",
  description: "QueryPie Terms of Service の preview ローカルページです。",
  alternates: {
      ...
      <section className="mx-auto max-w-[1920px] bg-white px-[30px] pb-[120px] pt-[112px] lg:px-[30px] lg:pb-[160px] lg:pt-[144px]">
        <div className="mx-auto max-w-[920px]">
          <div className="border-b border-[#d1d5db] pb-6">
            <h1 className="text-[34px] font-normal leading-[1.2] text-slate-950 lg:text-[40px]">利用規約</h1>
            <p className="mt-4 text-base leading-7 text-slate-500">
              corp-web-contents / corp-web-app の current Terms of Service content を元にした preview ページです。
            </p>
          </div>
