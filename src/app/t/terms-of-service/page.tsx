...
const termsOfServiceSource = String.raw`<Box direction="column" paddingTopSize="lg" paddingBottomSize="ultra" center>
    <CenterSection gapSize="lg">
        <StaticH1>{'QueryPie Terms of Service'}</StaticH1>
