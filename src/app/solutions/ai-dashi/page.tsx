...
const aiWallCards: ReadonlyArray<{
...
}> = [
  {
    icon: Users,
    title: "人材と技術の枯渇",
    body: "AI専門人材の確保が難しい。さらに最新アーキテクチャへの追従が、開発リソースを圧迫します。",
  },
  {
    icon: Database,
    title: "データ整備の泥沼",
    body: "RAG構築には膨大な工数がかかります。精度が出ないまま、リリースが延期されるリスクがあります。",
  },
  {
    icon: Settings,
    title: "肥大化するインフラ保守",
    body: "モデル更新、プロンプト調整、インフラ監視が継続的に発生。想定外の運用コストが利益を圧迫します。",
  },
] as const;
                  ...
                  <div className="flex flex-col justify-between gap-5 px-6 py-6 md:px-8 md:py-8">
                    <div>
                      ...
                      <p className="mt-4 text-[15px] leading-7 text-slate-600">
                        AIエージェント時代にSaaS企業が取るべき戦略と、QueryPie AI自身の変革事例をまとめた資料です。
                      </p>
                    </div>
