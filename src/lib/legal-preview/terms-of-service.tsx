...
function TermsMdxLink({ href, children }: LinkProps) {
  if (/^https?:\/\//.test(href)) {
    return (
...
export async function renderTermsOfServicePreviewMdx() {
  const sourcePath = join(process.cwd(), "src/content/legal-preview/terms-of-service.mdx");
