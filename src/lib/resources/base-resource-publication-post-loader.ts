  ...
  async getPost(id: string): Promise<PublicationPost | null> {
    ...
    if (isGated) {
      ...
      return {
        ...
        openGraphImageSrc: previewEvaluation.frontmatter.openGraphImageSrc,
        ...
        downloadCta: previewEvaluation.frontmatter.downloadCta ?? null,
        relatedTitle: "関連リソース",
