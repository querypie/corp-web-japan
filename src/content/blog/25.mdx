...
description: "QueryPie AI合同会社は、株式会社テラスカイと、AIエージェント「mitoco Buddy」開発に関する協業を発表しました。企業向けAIエージェントのセキュリティとデータ統制の基盤を共同で構築します。"
date: "2025年11月7日"
heroImageSrc: "/assets/image/blog/25/thumbnail.png"
relatedIds:
  - "23"
  - "22"
  - "21"
...
![QueryPie AI x mitoco](https://jbxeeb6ybylgemuz.public.blob.vercel-storage.com/main/public/blog/blog25-image-1-K2rxbqhfQFDwfOSrgp0L0pfNXiS1xx.png)
...
![mitoco Buddyのチャット画面](https://jbxeeb6ybylgemuz.public.blob.vercel-storage.com/main/public/blog/blog25-image-2-sP6qVOeETXdQ2w5T0aSGJCTdtzXKiz.png)
...
![LLMモデルの選択画面](https://jbxeeb6ybylgemuz.public.blob.vercel-storage.com/main/public/blog/blog25-image-3-Nr5f7muakNj43aojRhd7VZ0tmkTTz3.png)
...
- Email:[pr@querypie.com](/japr@querypie.com)
