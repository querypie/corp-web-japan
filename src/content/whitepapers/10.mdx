...
listDescription: QueryPie の DevSecOps パイプラインを使用して開発を合理化し、速度、安定性、セキュリティを強化します。
date: 2024年11月22日
heroImageSrc: /whitepapers/10/thumbnail.png
author:
- jake
- ravi
- noah
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-1-querypie-cicd-pipeline.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-2-types-of-vulns-to-check.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-3-vulnerability-scanning-tools.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-4-vulnerability-scan-report.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-5-hardening-process.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-6-vulnerability-detection-snyk.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-7-vulnerability-detection-github.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-8-cicd-migration-control-process.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-9-iac-scan.png"
        alt="IaCスキャン"
        caption="IaCスキャン"
    />
</Box>
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-10-dast.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/10/wp10-11-fuzzing.png"
