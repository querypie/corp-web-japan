...
listDescription: AIエージェントベースの自動化システムが拡大し、単なる自動化レベルを超えて、実行主体（エージェント）が独立して意思決定し外部システムを呼び出すAgentOpsが登場しました。本稿ではAgentOpsとともに登場したAgentSecOpsについて考察し、従来のDevSecOps体制と比べてどのような構造と役割を担うのかを深く分析します。
date: 2025年5月13日
heroImageSrc: /whitepapers/21/thumbnail.png
author: kenny
relatedIds:
- '18'
- '19'
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/21/wp21-1-comparison-of-agentops-execution-models.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/21/wp21-2-example-of-devsecops-pipeline.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/21/wp21-3-vulnerability-management-across-the-cloud-devsecops-pipeline.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/21/wp21-4-application-vulnerability-management.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/21/wp21-5-timeline-based-comparison-of-control-flow.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/21/wp21-6-agentsecops-component-architecture.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/21/wp21-7-architecture-with-mcp-pam.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/21/wp21-8-iac-security-flow.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/21/wp21-9-distributed-agent-execution-and-centralized-policy-analysis.png"
...
[18] [QueryPie, "Uncovering MCP Security," QueryPie White Paper, 2025.](https://www.querypie.com/resources/discover/whitepapers/18/uncovering-mcp-security)

[19] [QueryPie, "Redefining PAM for the MCP Era," QueryPie White Paper, 2025.](https://www.querypie.com/resources/discover/whitepapers/15/redefining-pam-for-the-mcp-era)

[20] D. Kozen and J. Millen, "Policy Composition in Access Control," IEEE Security & Privacy, vol. 14, no. 3, pp. 36–43, 2016.

[21] [QueryPie, "Next-Step MCP PAM Architecture," QueryPie Resource Center, 2025.](https://www.querypie.com/resources/discover/whitepapers/16/next-step-mcp-pam)
