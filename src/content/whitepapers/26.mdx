...
listDescription: "コード生成・Agentic RAGタスクに特化したLLM比較評価。研究背景・システムアーキテクチャ・実験設計を前編で詳解します。"
date: "2026年2月13日"
heroImageSrc: "/assets/image/whitepapers/26/thumbnail.png"
author: "edwin"
relatedIds:
  - "27"
  - "24"
...
> 本記事は前後編の**前編**です。前編では研究の背景・システムアーキテクチャ・実験設計を、[後編](https://www.querypie.com/ja/features/documentation/white-paper/27/llm-evaluation-agentic-rag-part2)では実験結果・パイプライン最適化・結論を取り扱います。
<br/>
<br/>
---
# 序論
...
> 第4章以降の実験結果・パイプライン最適化・結論は[後編](https://www.querypie.com/ja/features/documentation/white-paper/27/llm-evaluation-agentic-rag-part2)で取り扱います。
<br/>
<br/>
---
# 第1章　関連研究
...
<br/>
<br/>
> 📖 [後編](https://www.querypie.com/ja/features/documentation/white-paper/27/llm-evaluation-agentic-rag-part2)では、13モデルの実験結果（コード生成・Agentic RAG）、Thinkingモードの影響分析、安定性評価、コスト―品質トレードオフ、そして最適パイプライン構成戦略を詳しく取り扱います。
