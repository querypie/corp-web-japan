...
export function AICrewContactSection({ children }: { children: ReactNode }) {
  return (
    <section {...componentNameDebugProps("AICrewContactSection")} id="contact" className="w-full bg-white px-6 py-16 text-center lg:px-10 lg:py-20">
...
export function AICrewContactShell({ children }: { children: ReactNode }) {
  return (
    <div {...componentNameDebugProps("AICrewContactShell")} className="rounded-[2rem] bg-[#f9f9fb] px-8 py-10 shadow-[0_24px_70px_-50px_rgba(15,23,42,0.16)]">
...
export function AICrewContactIntro({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewContactIntro")} className="flex w-full flex-col items-center gap-4">{children}</div>;
}

export function AICrewContactTitle({ children }: { children: ReactNode }) {
  return (
    <h2 {...componentNameDebugProps("AICrewContactTitle")} className="text-center text-[34px] font-semibold leading-[1.16] tracking-[-0.04em] text-[#101828] sm:text-[42px] sm:leading-[50px]">
      {children}
    </h2>
  );
}
...
export function AICrewContactBody({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewContactBody")} className="w-full whitespace-pre-line text-center text-base leading-7 text-slate-500">{children}</div>;
}

export function AICrewContactActionGroup({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewContactActionGroup")} className="flex flex-col items-center gap-4 sm:flex-row sm:gap-[17px]">{children}</div>;
}

export function AICrewContactPrimaryAction({ href, children }: { href: string; children: ReactNode }) {
  return (
    <Link {...componentNameDebugProps("AICrewContactPrimaryAction")}
      href={href}
...
export function AICrewContactSecondaryAction({ href, children }: { href: string; children: ReactNode }) {
  return (
    <Link {...componentNameDebugProps("AICrewContactSecondaryAction")}
      href={href}
...
export function AICrewDashiPromo({ children }: { children: ReactNode }) {
  return (
    <div {...componentNameDebugProps("AICrewDashiPromo")} className="relative overflow-hidden rounded-[2rem] border border-[#d7dee7] bg-[linear-gradient(135deg,#f8fafc_0%,#eef4fb_48%,#e8eef7_100%)] px-8 py-8 text-left shadow-[0_28px_90px_-50px_rgba(15,23,42,0.18)]">
...
export function AICrewDashiPromoContent({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewDashiPromoContent")} className="max-w-[980px]">{children}</div>;
}

export function AICrewDashiPromoEyebrow({ children }: { children: ReactNode }) {
  return (
    <div {...componentNameDebugProps("AICrewDashiPromoEyebrow")} className="inline-flex rounded-full border border-[#d0d5dd] bg-white/80 px-3 py-1 text-xs font-semibold tracking-[0.12em] text-[#475467]">
      {children}
    </div>
  );
}
...
export function AICrewDashiPromoIcon({ children }: { children: ReactNode }) {
  return (
    <div {...componentNameDebugProps("AICrewDashiPromoIcon")} className="mt-5 flex h-12 w-12 items-center justify-center rounded-[14px] bg-[#2f3a49] text-white shadow-[0_16px_32px_-20px_rgba(15,23,42,0.45)]">
      {children}
    </div>
  );
}
...
export function AICrewDashiPromoTitle({ children }: { children: ReactNode }) {
  return (
    <h3 {...componentNameDebugProps("AICrewDashiPromoTitle")} className="mt-5 text-[30px] font-semibold leading-[1.35] tracking-[-0.03em] text-[#101828] xl:whitespace-nowrap">
      {children}
    </h3>
  );
}
...
export function AICrewDashiPromoBody({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewDashiPromoBody")} className="mt-4 max-w-[980px] text-left text-sm leading-7 text-[#475467]">{children}</div>;
}

export function AICrewDashiPromoAction({ href, children }: { href: string; children: ReactNode }) {
  return (
    <Link {...componentNameDebugProps("AICrewDashiPromoAction")}
      href={href}
...
export function AICrewDashiPromoVisual({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewDashiPromoVisual")} className="relative hidden h-[240px] lg:block">{children}</div>;
}

export function AICrewDashiPromoPanel({ children }: { children: ReactNode }) {
  return (
    <div {...componentNameDebugProps("AICrewDashiPromoPanel")} className="absolute right-0 top-0 w-[260px] rounded-[1.6rem] border border-white/70 bg-white/72 p-5 shadow-[0_24px_70px_-40px_rgba(15,23,42,0.18)] backdrop-blur-sm">
      {children}
    </div>
  );
}
...
export function AICrewDashiPromoPanelHeader({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewDashiPromoPanelHeader")} className="flex items-center justify-between">{children}</div>;
}

export function AICrewDashiPromoPanelLabel({ children }: { children: ReactNode }) {
  return <p {...componentNameDebugProps("AICrewDashiPromoPanelLabel")} className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[#98a2b3]">{children}</p>;
}

export function AICrewDashiPromoPanelStatusDot() {
  return <div {...componentNameDebugProps("AICrewDashiPromoPanelStatusDot")} className="h-2.5 w-2.5 rounded-full bg-[#2563EB]" />;
}

export function AICrewDashiPromoPanelList({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewDashiPromoPanelList")} className="mt-4 grid gap-3">{children}</div>;
}
...
export function AICrewDashiPromoPanelItem({
  ...
  return <div {...componentNameDebugProps("AICrewDashiPromoPanelItem")} className={className}>{children}</div>;
}

export function AICrewDashiPromoVisualOrb({ children }: { children?: ReactNode }) {
  return (
    <div {...componentNameDebugProps("AICrewDashiPromoVisualOrb")} className="absolute bottom-[10px] left-[8px] flex h-[72px] w-[72px] items-center justify-center rounded-[20px] border border-white/70 bg-white/72 text-[#2f3a49] shadow-[0_20px_40px_-24px_rgba(15,23,42,0.18)] backdrop-blur-sm">
      {children}
    </div>
  );
}
