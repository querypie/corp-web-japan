...
export function AICrewAboutSection({ children }: { children: ReactNode }) {
  return (
    <section {...componentNameDebugProps("AICrewAboutSection")} id="about" className="mx-auto max-w-[1920px] bg-[#f6f8fb] px-6 py-20 lg:px-10">
      {children}
    </section>
  );
}
...
export function AICrewAboutShell({ children }: { children: ReactNode }) {
  return (
    <div {...componentNameDebugProps("AICrewAboutShell")} className="mx-auto mt-8 max-w-[1120px]">
...
export function AICrewAboutIntro({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewAboutIntro")} className="max-w-[650px]">{children}</div>;
}

export function AICrewAboutTitle({ children }: { children: ReactNode }) {
  return (
    <RevealOnScroll {...componentNameDebugProps("AICrewAboutTitle")}>
      <h2 className="max-w-none text-[30px] font-semibold leading-[1.2] tracking-[-0.04em] text-[#101828] sm:text-[42px] sm:leading-[1.2] sm:whitespace-nowrap [&_strong]:bg-[linear-gradient(135deg,#0F2A5F_0%,#174EA6_52%,#2563EB_100%)] [&_strong]:bg-clip-text [&_strong]:font-semibold [&_strong]:text-transparent">
...
export function AICrewAboutBody({ children }: { children: ReactNode }) {
  return (
    <RevealOnScroll {...componentNameDebugProps("AICrewAboutBody")} delayMs={90}>
...
export function AICrewAboutImage({
  ...
  return (
    <RevealOnScroll {...componentNameDebugProps("AICrewAboutImage")} variant="scale" delayMs={120}>
