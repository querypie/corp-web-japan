...
export function AICrewPlatformSection({ children }: AICrewPlatformSectionProps) {
  return (
    <section {...componentNameDebugProps("AICrewPlatformSection")} id="platform" className="mx-auto max-w-[1920px] bg-[#f6f8fb] px-6 py-20 lg:px-10">
      {children}
    </section>
  );
}
...
export function AICrewPlatformHeader({ children }: AICrewPlatformSectionProps) {
  return <div {...componentNameDebugProps("AICrewPlatformHeader")} className="mx-auto max-w-[1120px] text-center">{children}</div>;
}

export function AICrewPlatformTitle({ children }: AICrewPlatformSectionProps) {
  return (
    <RevealOnScroll {...componentNameDebugProps("AICrewPlatformTitle")}>
...
export function AICrewPlatformBody({ children }: AICrewPlatformSectionProps) {
  return (
    <RevealOnScroll {...componentNameDebugProps("AICrewPlatformBody")} delayMs={80}>
...
export function AICrewPlatformAccent({ children }: AICrewPlatformSectionProps) {
  return <span {...componentNameDebugProps("AICrewPlatformAccent")} className={aiCrewPlatformAccentTextClass}>{children}</span>;
}

export function AICrewPlatformDiagram({ children }: AICrewPlatformSectionProps) {
  return (
    <RevealOnScroll {...componentNameDebugProps("AICrewPlatformDiagram")} className="mx-auto mt-12 max-w-[1120px]" variant="scale" delayMs={140}>
...
export function AICrewPlatformCore({ children }: AICrewPlatformSectionProps) {
  return (
    <div {...componentNameDebugProps("AICrewPlatformCore")} className="flex min-h-[210px] flex-col items-center justify-center rounded-[2rem] border border-[#c9d8f5]/80 bg-white/90 px-8 py-9 text-center shadow-[0_24px_70px_-50px_rgba(15,42,95,0.24)] backdrop-blur-sm md:col-span-2 lg:absolute lg:left-1/2 lg:top-1/2 lg:h-[218px] lg:w-[218px] lg:-translate-x-1/2 lg:-translate-y-1/2 lg:rounded-full lg:px-6">
      {children}
    </div>
  );
}
...
export function AICrewPlatformCoreEyebrow({ children }: AICrewPlatformSectionProps) {
  return (
    <p {...componentNameDebugProps("AICrewPlatformCoreEyebrow")} className="text-[10px] font-semibold uppercase tracking-[0.16em] text-[#6B86B5]">
      {children}
    </p>
  );
}
...
export function AICrewPlatformCoreTitle({ children }: AICrewPlatformSectionProps) {
  return (
    <p {...componentNameDebugProps("AICrewPlatformCoreTitle")} className="mt-2 pb-1 bg-[linear-gradient(135deg,#0F2A5F_0%,#174EA6_52%,#2563EB_100%)] bg-clip-text text-[26px] font-bold leading-[1.18] tracking-[-0.04em] text-transparent">
      {children}
    </p>
  );
}
...
export function AICrewPlatformCoreBody({ children }: AICrewPlatformSectionProps) {
  return <p {...componentNameDebugProps("AICrewPlatformCoreBody")} className="mt-2 text-[12px] font-medium leading-5 text-slate-600">{children}</p>;
}

export function AICrewPlatformCard({ children, position }: AICrewPlatformCardProps) {
  return (
    <article {...componentNameDebugProps("AICrewPlatformCard")}
...
export function AICrewPlatformCardHeader({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewPlatformCardHeader")} className="flex items-start gap-3">{children}</div>;
}
...
export function AICrewPlatformCardIcon({ icon }: AICrewPlatformCardIconProps) {
  ...
  return (
    <div {...componentNameDebugProps("AICrewPlatformCardIcon")} className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[12px] bg-[#eef2f7] text-[#2f3a49]">
...
export function AICrewPlatformCardText({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AICrewPlatformCardText")} className="min-w-0">{children}</div>;
}

export function AICrewPlatformCardTitle({ children, subtitle }: AICrewPlatformCardTitleProps) {
  return (
    <h3 {...componentNameDebugProps("AICrewPlatformCardTitle")} className="flex min-w-0 items-end gap-1.5 tracking-[-0.03em] text-slate-900">
...
export function AICrewPlatformCardStat({ children }: AICrewPlatformSectionProps) {
  return (
    <div {...componentNameDebugProps("AICrewPlatformCardStat")} className="mt-1.5 inline-flex rounded-full bg-[#2f3a49] px-3 py-1 text-[11px] font-semibold text-white">
      {children}
    </div>
  );
}
...
export function AICrewPlatformCardBody({ children }: AICrewPlatformSectionProps) {
  return <div {...componentNameDebugProps("AICrewPlatformCardBody")} className="mt-2.5 space-y-1.5">{children}</div>;
}

export function AICrewPlatformCardBullet({ children }: AICrewPlatformSectionProps) {
  return (
    <p {...componentNameDebugProps("AICrewPlatformCardBullet")} className="flex gap-2 text-[12px] font-medium leading-5 text-slate-700">
