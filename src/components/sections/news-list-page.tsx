    ...
    <>
      <section className="mx-auto max-w-[1920px] bg-white px-[30px] pb-[34px] pt-[111px] lg:px-[30px] lg:pb-[34px] lg:pt-[143px]">
        <div className="mx-auto max-w-[1200px] text-center">
          ...
          <p className="mx-auto mt-5 max-w-[760px] text-base leading-7 text-slate-500">{description}</p>
          <p className="mx-auto mt-4 max-w-[760px] text-sm leading-6 text-slate-400">
            QueryPie AI の公式発表はローカル詳細ページで確認でき、外部メディア掲載は掲載元の記事へ直接移動します。
          </p>
        </div>
      </section>
