...
export function AcpHeroVideo() {
  return (
    <div {...componentNameDebugProps("AcpHeroVideo")} className="mx-auto w-full max-w-[1024px]">
...
export function AcpEasyUseSection({ children }: { children: ReactNode }) {
  return <PlatformContentSection {...componentNameDebugProps("AcpEasyUseSection")} className="pb-[160px]">{children}</PlatformContentSection>;
}

export function AcpEasyUseInner({ children }: { children: ReactNode }) {
  return <div {...componentNameDebugProps("AcpEasyUseInner")} className="flex w-full max-w-[1200px] flex-col gap-[80px]">{children}</div>;
}
...
export function AcpEasyUseImage() {
  return (
    <div {...componentNameDebugProps("AcpEasyUseImage")} className="mx-auto max-w-[1000px]">
