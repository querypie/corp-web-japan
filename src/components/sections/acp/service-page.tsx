...
export function AcpIntegrationsTitle({ children }: { children: ReactNode }) {
  return <h4 {...componentNameDebugProps("AcpIntegrationsTitle")} className="text-[22px] font-medium leading-[30px] tracking-normal text-[#24292F] sm:text-[24px] sm:leading-[32px] lg:text-[25px] lg:leading-[33px] lg:whitespace-nowrap">{children}</h4>;
}
