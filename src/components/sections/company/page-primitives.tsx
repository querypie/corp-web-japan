...
const companyPageSectionPaddingClassNames = {
  default: "pb-[60px] pt-[100px] lg:pb-[80px] lg:pt-[130px]",
  compactHero: "pb-[60px] pt-[100px] lg:pb-[84px] lg:pt-[130px]",
  compactFooter: "pb-[60px] pt-[100px] lg:pb-[78px] lg:pt-[130px]",
