    ...
    >
      <div className="mx-auto w-full max-w-[1120px]">
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <h2 className="mt-3 text-[32px] font-semibold leading-[42px] tracking-normal text-slate-950 md:text-[42px] md:leading-[52px]">
            {title}
          </h2>
          {lead ? (
            <p className="mt-5 text-[16px] font-normal leading-7 text-slate-600 md:text-[17px] md:leading-8">
              {lead}
            </p>
          ) : null}
        </div>
