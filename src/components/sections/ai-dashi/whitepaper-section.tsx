...
export function AIDashiWhitepaperSection({ children }: { children: ReactNode }) {
  return <section className="mx-auto max-w-[1920px] bg-[#f8fafc] px-6 py-20 lg:px-10 lg:py-24">{children}</section>;
}
...
export function AIDashiWhitepaperEyebrow({ children }: { children: ReactNode }) {
  return <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#64748b]">{children}</p>;
}

export function AIDashiWhitepaperTitle({ children }: { children: ReactNode }) {
  return <h2 className="mt-2 text-[24px] font-semibold leading-[1.3] tracking-[-0.03em] text-slate-950 sm:text-[30px]">{children}</h2>;
}

export function AIDashiWhitepaperBody({ children }: { children: ReactNode }) {
  return <p className="mx-auto mt-4 max-w-[760px] text-left text-base leading-7 text-slate-500">{children}</p>;
}

export function AIDashiWhitepaperCard({ href, children }: { href: string; children: ReactNode }) {
  return (
    <RevealOnScroll variant="up" delayMs={120} className="w-full max-w-[980px]">
...
export function AIDashiWhitepaperCardBodyLayout({ children }: { children: ReactNode }) {
  return <div className="flex flex-col justify-between gap-5 px-6 py-6 md:px-8 md:py-8">{children}</div>;
}
...
export function AIDashiWhitepaperTag({ children }: { children: ReactNode }) {
  return <span className="inline-flex rounded-full bg-[#eef2f7] px-3 py-1 text-[11px] font-semibold tracking-[0.08em] text-[#2f3a49]">{children}</span>;
}

export function AIDashiWhitepaperCardTitle({ children }: { children: ReactNode }) {
  return <h3 className="mt-5 text-[24px] font-semibold leading-[1.4] tracking-[-0.03em] text-slate-950">{children}</h3>;
}
...
export function AIDashiWhitepaperAction({ children }: { children: ReactNode }) {
  return <div className="inline-flex items-center gap-2 text-sm font-semibold text-[#ED602E] transition group-hover:gap-2.5">{children}</div>;
}
