...
export const legalDocumentBodyClassName = [
  ...
  "[&_p]:mt-[1.3125rem] [&_p]:text-[15px] [&_p]:leading-7 [&_p]:text-slate-600",
  ...
  "[&_blockquote_p]:mt-0 [&_blockquote_p]:text-[15px] [&_blockquote_p]:leading-7 [&_blockquote_p]:text-slate-600",
