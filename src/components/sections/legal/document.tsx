...
export const legalDocumentBodyClassName = [
  ...
  "[&_h4]:mt-10 [&_h4]:text-base [&_h4]:font-medium [&_h4]:leading-6 [&_h4]:text-slate-950",
  "[&_p]:mt-[1.3125rem] [&_p]:leading-6 [&_p]:text-slate-600",
  ...
  "[&_li]:mb-2 [&_li]:leading-6 [&_li]:text-slate-600",
  ...
  "[&_blockquote_p]:mt-0 [&_blockquote_p]:leading-6 [&_blockquote_p]:text-slate-600",
  "[&_blockquote_li]:leading-6 [&_blockquote_li]:text-slate-600",
  "[&_table]:my-[34px] [&_table]:w-full [&_table]:border-collapse [&_table]:border-t [&_table]:border-b [&_table]:border-[#d1d5db]",
