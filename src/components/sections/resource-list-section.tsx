...
export function ResourceListSidebarList({ children }: { children: ReactNode }) {
  return <ul className="flex flex-col gap-3 lg:gap-0">{children}</ul>;
}
...
export function ResourceListSidebarLink({
  ...
  return (
    <Link
      href={href}
      className={`flex w-full items-center justify-between rounded-[12px] px-4 py-3.5 text-[15px] leading-[1.467] transition lg:block lg:rounded-none lg:px-0 lg:py-0 ${
        active
