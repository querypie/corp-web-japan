...
Expected current result: only the 13 route files below.
...
| `src/app/platform/ai/aip/usage-based-llm/route.ts` | `https://www.querypie.com/ja/solutions/aip/usage-based-llm` | `/t/platforms/aip/usage-based-llm`, later `/platforms/aip/usage-based-llm` | Legacy redirect still external. |
